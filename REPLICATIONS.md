...
|---|---|---|---|---|---|
| 2026-06 | R. Furui (author) | `fable-model-chain` full run (`run_all.py --json`) | Windows 11, Python 3.11 | ✅ matches manuscript v5 | Baseline; `results.json` in repo |
| 2026-07 | R. Furui (author) | `fable-model-quantum` full run (`run_all.py --json`) | Windows 11, Python 3.11 | ✅ matches manuscript Part II | Baseline; `results.json` in repo |
