...
> **Post-promotion note — 2026-07-26 (post-promotion).** Four items, three of them recorded by this note's own assessors. (i) §4's **E1** row ("new element: none") and the §5 key `f_max_F2_flushed_THz` = 0.115 [0.079, 0.153] now carry the burst-scaling proviso of [2026-07-25-e1-burst-scaling-proviso.md](2026-07-25-e1-burst-scaling-proviso.md): with the released fixed 3-cycle burst F = 2 falls 0.9–3.0 dB short at **every** slot, closure needs ncyc ≈ 12, and the 0.115 THz band centre is reached at no measured burst length. (ii) §0.2's pedestal figures are **floor-referenced**; referred to the mean-'1' data level they are +10.0/+28.4 dB, so the derived quiet-switching spec reads ≥ ~20–38 dB, not ≥ 27–45 dB. (iii) §5's non-contest gloss under-quotes the 07-22 falsification clause, which includes "(or a loaded/gated time-domain transient)". (iv) §4's **E3** row omits its **81 GHz** demonstrated-calibrated corner, where the active de-Q buys 0 % of clock. The §4 verdict and the ≈0.1 THz headline are unaffected. Full supersession map: [notes/INDEX.md](INDEX.md).
