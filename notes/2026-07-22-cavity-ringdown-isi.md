...
> **Resolution and scope — 2026-07-26 (post-promotion).** (i) §7.3's **sufficiency** question is resolved: a passive per-slot flush is insufficient ([2026-07-22-flush-noise-figure-negative.md](2026-07-22-flush-noise-figure-negative.md)), and **no de-Q rate — including D = ∞ — closes the composed F = 2 ledger at the 4-ps slot** ([2026-07-23-reset-switch-adjudication.md](2026-07-23-reset-switch-adjudication.md), which ran the gated transient this note predicted). (ii) The §5 key `ringdown_isi_pp_dB_0p7_0p25THz` = 4.0 [2.0, 4.5] is **scoped to this note's own §6 sampling conventions**: under the stricter burst-window convention the same quantity measured **4.90** (07-23) and **4.91** (07-25), both adjudicated 3-of-3 as new-convention data points. This discharges the action item the 07-23 assessors ordered. §1's anchors and the flush-necessity verdict are untouched. Full supersession map: [notes/INDEX.md](INDEX.md).
