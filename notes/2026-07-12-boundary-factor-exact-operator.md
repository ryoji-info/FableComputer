...
> **Correction — 2026-08-13 (post-promotion): §3's continuum reference "0.245405 (BVP estimate)".** 0.245405 is the additive predictor `0.25 − (0.25M² + δ_relax)` to its printed precision, not a separate solve; the **exact** continuum line centre of the same linearized system (eigencondition `d·cosh d = t·sinh d`, released closures) is **0.245398906** — lower by the drift × damping cross-term C = 6.34×10⁻⁶ at this bias, per [2026-08-13-walk-excess-clamp-placement.md](2026-08-13-walk-excess-clamp-placement.md) §6. This note's own discrete operator value 0.244513 is untouched and was confirmed **bit-equal** there; nothing else here consumes the BVP-estimate column. The original text below is unedited.
...
> **Correction — 2026-07-26 (post-promotion).** §4's in-model split of the 0.909 dB residual (≈0.5 dB compression + ≈0.4 dB train/estimator) had the right **sum** and **inverted proportions**: the drive sweep of [2026-07-17-drive-sweep-knee-anchored.md](2026-07-17-drive-sweep-knee-anchored.md) §0.2/§6 measures **0.8541 dB** of linear pulse-train/per-slot-peak-estimator structure plus **0.0544 dB** of compression at the operating drive (sum 0.9085 ✓). §4's own "the split is open pending a drive sweep" was the correct call; the 0.9558 dB linear-numerics share and all three §6 predictions stand. Full supersession map: [notes/INDEX.md](INDEX.md).
